...
#    La raíz del proyecto (donde está manage.py y aula_inteligente.settings) está un nivel por encima.
project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
sys.path.append(project_root)

# 3. Establecer la variable de entorno para las configuraciones de Django.
#    'aula_inteligente' debe ser el nombre del directorio que contiene settings.py (tu proyecto principal de Django).
